...
import { SociaNetworkAssets, GithubIcon, InternetIcon } from '../assets'
...
const SocialNetwork = () => {
  ...
  return (
    ...
    <h3 className='heading-2 mb-2'>Social Network</h3>
    <p className='paragraph max-w-[50%]'>“Social Network” is a front-end only web application</p>

    <motion.img src={SociaNetworkAssets} alt="Crveno Vino mockups image" className="block mx-auto px-12 my-24" style={{scale}}/>
      ...
      <div className='grid  grid-cols-1 md:grid-cols-12 items-center'>
        ...
        <div className="col-span-7">
          ...
          <p className='paragraph-lg mb-4'>HTML, CSS, JavaScript, MockAPI</p>
          <div className="flex">
